    ...
    return (
        <div className={"mt-5 mx-4 flex-1"}>
            ...
            <div className={"grid grid-cols-4 gap-4 mt-8"}>
                ...
                <div className={"shadow-2xl flex rounded-2xl border p-5 hover:scale-95 cursor-pointer"}>
                    <div>
                    ...
                    <div className="ml-10 items-center justify-center">
                        <img src={groupofteachers} className="h-24 w-28 rounded-lg object-fill" />
                    </div>
                </div>
                ...
                <div className={"shadow-2xl flex rounded-2xl border p-5 hover:scale-95 cursor-pointer"}>
                    ...
                    <div>
                        <div className="ml-10 items-center justify-center">
                            <img src={totalinventory} className="h-24 w-28 rounded-lg object-fill" />
                        </div>
                    </div>
                </div>
            </div>
