    ...
    return(
        <div className={"flex-1 mt-5 mx-4"}>
            ...
            <div className={"flex-1"}>
                <div className={""}>
                    <div className={"flex mt-8"}>
                        ...
                        <div className={"h-1/12 w-2/12 shadow-2xl rounded-2xl border hover:scale-95 cursor-pointer"}>
                            <div className={"mx-3 py-2 max-w-xs"}>
                                <p className={"text-4xl font-extrabold"}>1,400</p>
                                <p className={"py-2 text-lg font-bold text-gray-700"}>Total Students</p>
                                <p className={"text-green-600 flex text-sm font-bold"}>9% <p className={"ml-2 text-sm text-gray-700"}>than last month</p></p>
                            </div>
                        </div>

                        <div className={"h-1/12 w-2/12 shadow-2xl rounded-2xl border ml-5 hover:scale-95 cursor-pointer"}>
                            <div className={"mx-3 py-2 max-w-xs"}>
                                <p className={"text-4xl font-extrabold"}>300</p>
                                <p className={"py-2 text-lg font-bold text-gray-700"}>Total Teachers</p>
                                <p className={"text-green-600 flex text-sm font-bold"}>3% <p
                                    className={"ml-2 text-sm text-gray-700"}>than last month</p></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={"flex mt-10"}>
                        <div className={"h-1/12 w-2/12 shadow-2xl rounded-2xl border hover:scale-95 cursor-pointer"}>
                            <div className={"mx-3 py-2 max-w-xs"}>
                                ...
                                <p className={"text-green-600 flex text-sm font-bold"}>5%<p
                                    className={"ml-2 text-sm text-gray-700"}>than last month</p></p>
                            </div>
                        </div>
                        <div className={"h-1/12 w-2/12 shadow-2xl rounded-2xl border ml-5 hover:scale-95 cursor-pointer"}>
                            <div className={"mx-3 py-2 max-w-xs "}>
                                ...
                                <p className={"text-red-600 flex text-sm font-bold"}>-10% <p
                                    className={"ml-2 text-sm text-gray-700"}>than last month</p></p>
                            </div>
                        </div>
                    </div>
                ...
                <div className={"flex-1 mt-10"}>
                    <div className={"h-60 w-6/12 shadow-2xl rounded-2xl border ml-5"}>
                        <div className={"mx-3 py-2"}>
                            <p className={"text-4xl font-extrabold"}>Good Morning Samuel</p>
                            <div className={"max-w-sm"}>
                                <p className={"py-2 text-lg font-medium text-gray-700"}>Lorem Ipsum dolor sit amet, consecteur adipiscing elit, sed do eiusmod tempor incididunt ut labore et </p>
                            </div>
            ...
            <div className={"mt-10 mb-5"}>
                <div className={"h-60 w-6/12 shadow-2xl rounded-2xl border ml-5"}>
                    <div className={"mx-4 py-2  justify-between flex"}>
                        ...
                        <div className={"h-10 w-3/12 rounded-lg border border-gray-500 shadow-2xl"}>
                            <div className={"items-center justify-center mx-2 py-2.5"}>
                                <div className={"flex"}>
                                    <div className={"flex"}>
                                    ...
                                    <div className={"flex ml-2"}>
                                        <div className={"h-5 w-5 bg-red-600"}>
                ...
                <div className={"h-48 w-6/12 rounded-lg shadow-2xl border mt-10"}>
                    <div className={"mx-4 py-2"}>
                        <div>
                            ...
                            <div className={"flex mt-5"}>
                                ...
                                <p className={"ml-2"}>Payment of school fees remind not sent to students</p>

                                <div className={"h-5 w-20 border border-blue-500 rounded-full ml-48 cursor-pointer hover:scale-110"}>
                                    <div>
                                        <p className={"text-xs text-blue-500 text-center"}>Click</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div className={"h-80 w-4/12 rounded-lg shadow-2xl border mt-10"}>
                    <div className={"mx-4 py-2"}>
