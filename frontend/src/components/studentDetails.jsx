...
const StudentDetail = () => {
    ...
    return (
        <div className="w-3/12 p-6 bg-white shadow-md">
            ...
            <div className="space-y-2 py-1">
                ...
                <div className={"py-3"}>
                    ...
                    <p className={
                        `font-semibold h-10 w-4/12 rounded-lg border border-gray-500 shadow-2xl text-center ${student.payment_status === 'Have Paid' ? 'bg-green-500 text-white' : 'bg-red-500 text-white'}`
                    }>
            ...
            <div className={"flex justify-center mt-8"}>
                <div className={"h-12 w-7/12 rounded-lg border border-gray-500 bg-blue-500 shadow-2xl hover:scale-110 cursor-pointer"}>
                    <p className={"text-lg font-bold text-white text-center mt-2"}>Assets</p>
                </div>
